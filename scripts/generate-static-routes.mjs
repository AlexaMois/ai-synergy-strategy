...
const staticMeta = {
  ...
  '/start': {
    title: 'Разбор цифровых задач для собственника — 17 000 ₽ | Александра Моисеева',
    description: 'Разбор цифровых задач для собственника за 17 000 ₽: где компания теряет время и деньги, что автоматизировать первым и какой следующий шаг. Онлайн по всей России.',
  },
  '/services': {
  ...
  '/cases/aktransservice': {
    title: 'Кейс «АкТрансСервис»: цифровизация работы с 53 000 позиций' + DEFAULT_TITLE_SUFFIX,
  ...
  '/materials/checklist-30': {
    ...
    description: 'Бесплатный чек-лист для самопроверки: какие зоны в компании готовы к цифровизации, а какие — нет.',
  },
