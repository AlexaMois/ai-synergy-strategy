      ...
      <div className="container mx-auto px-4 max-w-[1200px]">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
          ...
          >
            ...
            <p className="text-sm md:text-base text-foreground mb-4 md:mb-6">
              Для производственных компаний и складов. AI для прогнозирования спроса, оптимизации закупок, контроля качества, аналитики маржи по продуктам. Экономия на хранении +300 тыс. ₽ в месяц.
            </p>
            <Button asChild className="w-full text-sm md:text-base">
