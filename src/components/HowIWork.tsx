        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {steps.map((step, index) => (
              ...
              >
              <div className="w-20 h-20 mx-auto mb-6 rounded-full border-4 border-accent flex items-center justify-center shadow-card transition-transform duration-300 hover:scale-[1.02]">
