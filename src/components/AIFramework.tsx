...
const AIFramework = () => {
  ...
  return <section id="methodology" ref={ref} className="py-20 px-6 md:px-20 max-w-[1360px] mx-auto bg-background">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
        {pillars.map((pillar, index) => <div key={index} className={`rounded-2xl p-6 shadow-card transition-all duration-300 cursor-pointer ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`} style={{
