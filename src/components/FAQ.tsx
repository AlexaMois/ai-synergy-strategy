  ...
  const faqs: { question: string; answer: JSX.Element }[] = [
    {
      ...
      answer: (
        <div className="space-y-3">
          <p>Стоимость зависит не от «ИИ», а от задачи и масштаба процессов.</p>
          <p>Начинаю с диагностики за 15 000 ₽, после которой становится понятно:</p>
          <div className="space-y-1">
            <p>• где ИИ даст эффект уже в первый месяц</p>
            <p>• какие решения не стоит внедрять вообще</p>
            <p>• сколько реально стоит проект, а не «по ощущениям»</p>
          </div>
          <p className="font-medium">Типовые бюджеты:</p>
          <div className="space-y-1">
            <p>• диагностика и стратегия — от 15 000 ₽</p>
            <p>• архитектура и внедрение — от 150 000 ₽</p>
            <p>• сопровождение и обучение — от 60 000 ₽ в месяц</p>
          </div>
          <p>👉 Это дешевле, чем ошибиться с первым решением.</p>
        </div>
      ),
    },
    {
      ...
      answer: (
        <div className="space-y-3">
          ...
          <p>Считаю окупаемость не «в теории», а в конкретных показателях:</p>
          <div className="space-y-1">
    ...
    },
    {
      ...
      answer: (
        <div className="space-y-3">
          ...
          <p>Регулярно вижу ситуации, где: «Дешевле было не начинать, чем потом переделывать».</p>
          <p>Проектирую промышленные решения, а не демо-ботов.</p>
        </div>
      ),
    },
    {
      ...
      answer: (
        <div className="space-y-3">
          <p>ИИ не универсален. Именно поэтому не продаю решение без диагностики.</p>
          <p>На старте разбираю: ваши процессы, данные, людей, ограничения.</p>
    ...
    },
    {
      ...
      answer: (
        <div className="space-y-3">
          ...
          <p>Поэтому:</p>
          <div className="space-y-1">
            <p>• встраиваю ИИ в привычные инструменты (Telegram, Google Sheets, CRM)</p>
            <p>• показываю выгоду каждой роли</p>
            <p>• обучаю команду, а не просто запускаю систему</p>
          </div>
    ...
    },
    {
      ...
      answer: (
        <div className="space-y-3">
          ...
          <p>Не продаю ИИ «любой ценой». Моя задача — результат, а не внедрение ради галочки.</p>
        </div>
      ),
    },
    {
      ...
      answer: (
        <div className="space-y-3">
          <p>Нет.</p>
          <p>Специально проектирую системы так, чтобы:</p>
          <div className="space-y-1">
    ...
    },
    {
      ...
      answer: (
        <div className="space-y-3">
          <p>Да.</p>
          <p>Использую: закрытые контуры, локальные модели, решения без передачи данных в облако.</p>
