...
const faqData = [
  ...
  },
  {
    ...
    answerText: "В наших кейсах средняя окупаемость решений — 3 месяца. Считаем окупаемость не «в теории», а в конкретных показателях: экономия часов сотрудников, снижение потерь заявок, ускорение платежей, снижение брака и переделок. Если окупаемость дольше 6 месяцев — мы честно говорим, что проект нецелесообразен.",
  },
  {
  ...
  },
  {
    ...
    answerText: "ИИ не универсален. Именно поэтому мы не продаём решение без разбора процессов. На старте разбираем: ваши процессы, данные, людей, ограничения. И даём честный ответ: где ИИ даст результат, где нужен порядок, а не нейросеть, где автоматизация вообще не нужна.",
  },
  {
  ...
  },
  {
    ...
    answerText: "Тогда вы узнаете это до больших затрат. Разбор процессов нужен именно для этого: проверить гипотезы, посчитать экономику, не тратить бюджет впустую. Мы не продаём ИИ «любой ценой».",
  },
  {
  ...
  },
  {
    ...
    answerText: "Не с выбора бота и не с покупки сервера. Правильный порядок: разбор бизнес-процессов, расчёт экономики, архитектура решения, пилот, масштабирование. Именно так ИИ становится инструментом бизнеса, а не экспериментом.",
  },
];
...
const faqRichAnswers: JSX.Element[] = [
  ...
  <div className="space-y-3">
    <p>В наших кейсах средняя окупаемость решений — 3 месяца.</p>
    ...
    <p>Если окупаемость дольше 6 месяцев — мы честно говорим, что проект нецелесообразен.</p>
  </div>,
  <div className="space-y-3">
  ...
  <div className="space-y-3">
    <p>ИИ не универсален. Именно поэтому мы не продаём решение без разбора процессов.</p>
  ...
  <div className="space-y-3">
    ...
    <p>Разбор процессов нужен именно для этого:</p>
    <div className="space-y-1">
  ...
  <div className="space-y-3">
    ...
    <p>👉 Если сомневаетесь — начните с разбора процессов.</p>
  </div>,
];
