  ...
  const faqs: { question: string; answer: JSX.Element }[] = [
    {
      ...
      answer: (
        <div className="space-y-3">
          ...
          <p>Мы начинаем с диагностики за 15 000 ₽, после которой становится понятно:</p>
    ...
    },
    {
      ...
      answer: (
        <div className="space-y-3">
          ...
          <p>Мы считаем окупаемость не «в теории», а в конкретных показателях:</p>
          <div className="space-y-1">
    ...
    },
    {
      ...
      answer: (
        <div className="space-y-3">
          ...
          <p>На старте мы разбираем: ваши процессы, данные, людей, ограничения.</p>
    ...
    },
    {
      ...
      answer: (
        <div className="space-y-3">
          <p>Да.</p>
          <p>Мы используем: закрытые контуры, локальные модели, решения без передачи данных в облако.</p>
