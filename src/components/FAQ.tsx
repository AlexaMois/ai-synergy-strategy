  ...
  const faqs: { question: string; answer: string; icon: LucideIcon }[] = [
    {
      ...
      answer:
        "Стоимость зависит от задач. На аудите показываю, что даст результат и какой бюджет рационален",
      icon: DollarSign,
    },
    {
      question: "Сколько времени занимает внедрение",
      answer:
        "Первые эффекты возможны через 2–4 недели",
      icon: Clock,
    },
    {
      question: "Команда поймёт, что происходит",
      answer:
        "Да. Объясняю простым языком и обучаю сотрудников",
      icon: Users,
    },
    {
      question: "А если решение не сработает",
      answer:
        "На этапе аудита определяю, что будет работать, а что нет",
      icon: Shield,
    },
    {
      question: "Вы работаете с нашей отраслью",
      answer:
        "Работаю с задачей и процессом, а не с отраслью",
      icon: Briefcase,
    },
    {
      question: "Будем зависеть от вас",
      answer:
        "Нет. Проектирую решения, которые вы сможете поддерживать сами",
      icon: Unlock,
    },
  ];
