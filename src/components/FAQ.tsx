...
const faqData = [
  ...
  },
  {
    ...
    answerText: "Тогда вы узнаете это до больших затрат. Разбор процессов нужна именно для этого: проверить гипотезы, посчитать экономику, не тратить бюджет впустую. Мы не продаём ИИ «любой ценой».",
  },
  {
...
const faqRichAnswers: JSX.Element[] = [
  ...
  <div className="space-y-3">
    ...
    <p>Разбор процессов нужна именно для этого:</p>
    <div className="space-y-1">
