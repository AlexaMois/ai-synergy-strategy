        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 mb-8">
          ...
          <div>
            ...
            <p className="text-background/80 text-base leading-relaxed">
              Независимый инженер и архитектор цифрового развития бизнеса<br />
              ​Даю честную оценку, считаю экономику и заранее определяю критерии результата<br />
              ​
            </p>
          </div>
          ...
          <div>
            ...
            <div className="flex flex-col gap-2 text-background/80 text-sm">
              ...
              <DisabledLink to="/about#contacts" className="hover:text-primary transition-colors">Контакты</DisabledLink>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex flex-col gap-3 text-background/80">
              <a href="tel:+79950788837" className="flex items-center gap-2 text-base hover:text-primary transition-colors">
