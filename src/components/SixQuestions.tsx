...
const SixQuestions = () => {
  ...
  const questions = [{
    number: "01",
    keyword: "Что",
    text: "какую задачу реально решаем: автоматизацию, аналитику, качество или скорость"
  }, {
    number: "02",
    keyword: "Где",
      ...
      <div className="container mx-auto px-4 max-w-[1200px]">
        ...
        transitionDelay: isVisible ? "700ms" : "0ms"
          ...
          <p className="text-lg md:text-xl text-text-body mb-4">
            После этого половина хотелок давайте внедрим ИИ отпадает сама
          </p>
          <p className="text-xl font-iriska font-bold text-primary md:text-3xl">
            Остаются решения, которые работают и окупаются
          </p>
        </div>
      </div>
    </section>;
