  ...
  const services = [
    {
      ...
      description: "Анализируем ваши процессы и говорим прямо: где ИИ окупится, а где — лишние расходы. Без продажи ради продажи.",
      pricing: "от 15 000 ₽",
      details: [
        "Диагностика ваших процессов",
        "Честное письменное заключение: нужна ли вам цифровизация или автоматизация с помощью ИИ"
      ],
      result: "Получаете дорожную карту с конкретными шагами и расчётом ROI. Средняя экономия по итогам диагностики — от 150 000 ₽/мес.",
    ...
    },
    {
      icon: Layers,
      title: "Архитектура",
      subtitle: "Проект под ваши процессы — рабочая схема и система под вашу инфраструктуру",
