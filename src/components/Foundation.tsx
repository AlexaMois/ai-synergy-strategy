  ...
  const services = [
    {
      ...
      description: "Консалтинг и дорожная карта по внедрению искусственного интеллекта. За 60 минут проанализируем ваши бизнес-процессы и скажем честно: нужна ли вам нейросеть и где она даст результат в первый месяц.",
      pricing: "от 15 000 ₽",
      details: [
