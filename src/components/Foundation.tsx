...
const Foundation = () => {
  ...
  const services = [
    ...
    },
    {
      ...
      description: "Проектирование и разработка AI решений, которые встраиваются в вашу привычную ИТ-инфраструктуру, систему обслуживания и производственные процессы без переделок. Интеграция ChatGPT, GigaChat или локальных моделей в бизнес-процессы, Telegram-бот.",
      pricing: "от 150 000 ₽",
      details: [
