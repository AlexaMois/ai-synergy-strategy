  ...
  const services = [
    {
      ...
      description: "Консалтинг и дорожная карта по внедрению искусственного интеллекта. За 60 минут проанализирую ваши бизнес-процессы и скажу честно: нужна ли вам нейросеть и где она даст результат в первый месяц.",
      pricing: "от 15 000 ₽",
      details: [
