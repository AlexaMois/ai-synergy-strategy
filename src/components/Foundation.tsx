...
const Foundation = () => {
  ...
  const services = [
    ...
    },
    {
      ...
      description: "Проектируем AI-решение, которое встраивается в вашу инфраструктуру. Вы получаете ТЗ и BPMN-схемы — документы, с которыми работает любая команда.",
      pricing: "от 150 000 ₽",
      details: [
