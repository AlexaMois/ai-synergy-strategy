  ...
  const services = [
    {
      ...
      subtitle: "Как внедрить ИИ в бизнес правильно и без финансовых потерь",
      description: "Консалтинг и дорожная карта по внедрению искусственного интеллекта. Проанализируем ваши бизнес-процессы и скажем честно: нужна ли вам нейросеть или нет, и где она даст результат в первый месяц.",
      pricing: "от 15 000 ₽",
      details: [
        "Диагностика ваших процессов",
        "Честное письменное заключение: нужна ли вам цифровизация или автоматизация с помощью ИИ"
      ],
      result: "Вы точно знаете, с чего начать внедрение, и экономите бюджет, не начиная лишнего.",
      process: "Встреча → анализ → дорожная карта / отчет с рекомендациями",
    ...
    },
    {
      icon: Layers,
      title: "Архитектура",
      subtitle: "Проектирование AI решений под ключ для вашей компании",
      description: "Проектирование, стратегия и разработка логики и структуры AI решений, которые идеально встраиваются в вашу привычную ИТ-инфраструктуру и бизнес-процессы.",
      pricing: "от 150 000 ₽",
      details: [
        "Подбор решений и сервисов (мы не втюхиваем свои решения или решения партнеров - мы делаем честную оценку защищая интересы заказчика)",
        "План интеграции ИИ в существующие ИТ-системы"
      ],
      result: "Не просто рекомендации, а рабочие документы: ТЗ для разработчиков и BPMN-схемы под ваши процессы. Можете внедрять с нами или с любой другой командой — документы ваши.",
    ...
    },
    {
      icon: Users,
      title: "Сопровождение",
      subtitle: "Обучение персонала, настройка ИИ под компанию, сопровождение внедрения",
      description: "Запускаем систему, обучаем команду работать с ИИ, настраиваем инструменты под ваши процессы и сопровождаем внедрение любого вендора. Работаем только в интересах заказчика — без привязки к партнёрским решениям.",
      pricing: "от 60 000 ₽/месяц",
      details: [
        "Настройка и донастройка ИИ под задачи компании",
        "Сопровождение внедрения — с любым вендором или командой",
        "Еженедельный контроль результатов, метрик и стоимости"
      ],
      result: "Система работает и используется командой. Метрики растут на 20–50% за месяц. Вы свободны в выборе подрядчика — мы на вашей стороне.",
