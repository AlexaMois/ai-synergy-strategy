...
const Foundation = () => {
  ...
  const services = [
    ...
    },
    {
      ...
      description: "Не просто запускаем систему — контролируем результаты. Обучаем вашу команду работе с нейросетями, гарантируем метрики. Сопровождение включает еженедельный контроль качества и корректировки.",
