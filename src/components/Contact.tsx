  ...
  return <section id="contact" ref={ref} className="relative py-10 md:py-16 lg:py-20 bg-background overflow-hidden">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="">
            <span className="lg:whitespace-nowrap">Любую задачу в ИИ можно решить за <span className="font-semibold"><span className={`text-2xl sm:text-3xl md:text-4xl inline-block ${getStaggeredClass(1, 'animate-scale-in')}`}>5</span> минут</span> или за <span className="font-semibold"><span className={`text-2xl sm:text-3xl md:text-4xl inline-block ${getStaggeredClass(2, 'animate-scale-in')}`}>5</span> миллионов</span>.</span> Выбор за вами.
          </h2>
          ...
          <div className={`mt-12 pt-12 border-t border-border ${getStaggeredClass(5, 'animate-fade-in-up')}`}>
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 text-lg text-text-body">
              <div className="p-4 sm:p-6 rounded-xl bg-[hsl(var(--gray-50))] shadow-card transition-all duration-300 hover:scale-[1.02] hover:bg-primary-light/30 gradient-border-gray gradient-border-gray-hover">
                ...
                <a className="hover:text-accent transition-colors" href="mailto:ai@aleksamois.ru">ai@aleksamois.ru</a>
              </div>
              <div className="p-4 sm:p-6 rounded-xl bg-[hsl(var(--gray-50))] shadow-card transition-all duration-300 hover:scale-[1.02] hover:bg-primary-light/30 gradient-border-gray gradient-border-gray-hover">
