...
const HowIChoose = () => {
  ...
  const criteria = [
    {
      number: "01",
      title: "Готовность команды (главный блокировщик)",
      question: "Ваш мастер цеха готов говорить в голосовой диктофон или будет возмущаться? Согласится ли менеджер, что система ловит его ошибки, или будет её обходить? Вверит ли бухгалтер данные в 1С или будет дублировать в Excel?",
      answer: "Если вижу блокировщиков — начинаю не с ИИ, а с выравнивания команды. Это добавляет 2–4 недели, но система потом работает годами, а не месяцами."
    },
    {
      number: "02",
      ...
      answer: "Если повторяется >5 раз в день — это рутина. Я считаю часы в месяц и показываю, где можно освободить людей для важного."
    },
    {
      number: "03",
      title: "Стоимость ошибки",
      question: "Сколько стоит вам одна ошибка в документе? Потеря клиента? Штраф от контрагента?",
      answer: "Ошибка в документе — штраф. Ошибка в заказе — возврат и потеря клиента. Я оцениваю цену ошибки и показываю, где ИИ исключит человеческий фактор."
    },
    {
      number: "04",
      ...
      answer: "Если есть документы, звонки, отчёты — покажу, как превратить в управляемый актив. Если данных нет — сначала настроим сбор, потом ИИ. Не обещаю волшебство из ничего."
    },
    {
      number: "05",
      title: "Срок окупаемости",
      question: "Вы готовы подождать 3–6 месяцев на результат? Или нужно \"вчера\"?",
      answer: "Я не беру проекты с окупаемостью >6 месяцев. Считаю ROI на каждом этапе: снижение брака, скорость ответа, высвобождение времени. Если считаю, что счёт не сходится — я говорю прямо."
    }
  ];
