  ...
  const criteria = [
    {
      ...
      answer:
        "Оцениваю готовность сотрудников и руководителей к изменениям. При сопротивлении начинаю с выравнивания команды, ролей и правил работы. Это добавляет 2–4 недели, зато система потом работает годами.",
    },
    {
      number: "02",
    ...
    },
    {
      ...
      answer:
        "Проверяю данные как управленческий актив. При разрозненных данных сначала выстраиваю сбор, структуру и правила работы с ними. После этого цифровой инструмент даёт устойчивый результат.",
    },
    {
      number: "05",
      ...
      answer:
        "Считаю экономику на каждом этапе: снижение ручной нагрузки, скорость ответа, количество ошибок, высвобождение времени. При слабой экономике проекта предлагаю другой формат работы.",
    },
  ];
