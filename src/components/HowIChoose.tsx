  ...
  const criteria = [
    {
      ...
      question:
        "Ваш мастер цеха готов говорить в голосовой диктофон или будет возмущаться? Согласится ли менеджер, что система ловит его ошибки, или будет её обходить? Вверит ли бухгалтер данные в 1С или будет дублировать в Excel?",
      answer:
        "Если вижу блокировщиков — начинаю не с ИИ, а с выравнивания команды. Это добавляет 2–4 недели, но система потом работает годами, а не месяцами.",
    },
    {
      number: "02",
      ...
      answer:
        "Если повторяется >5 раз в день — это рутина. Я считаю часы в месяц и показываю, где можно освободить людей для важного.",
    },
    {
      number: "03",
