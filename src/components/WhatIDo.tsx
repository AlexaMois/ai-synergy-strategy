          ...
          <div className="space-y-6">
            {cards.map((card, index) => {
              ...
              return (
                <div
                  key={index}
                  className={`p-6 rounded-2xl shadow-card transition-all duration-300 hover:shadow-hover hover:-translate-y-1 hover:scale-[1.02] ${isVisible ? 'animate-fade-in-up' : 'opacity-0'}`}
                  style={{
