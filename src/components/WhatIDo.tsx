        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="space-y-6">
            {cards.map((card, index) => (
              <div
                key={index}
                className={`p-8 rounded-2xl shadow-[0_8px_20px_rgba(0,0,0,0.04)] transition-all duration-300 hover:shadow-[0_12px_28px_rgba(0,0,0,0.08)] ${isVisible ? 'animate-fade-in-up' : 'opacity-0'}`}
                style={{
