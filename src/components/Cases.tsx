  ...
  const cases = [
    {
      ...
      resultsSummary: "1,3 млн ₽ разовой экономии капитальных затрат за счёт отказа от покупки серверного оборудования / 2 сотрудника освобождены от рутины / Сроки договоров под автоматическим контролем / Финансовый отдел экономит 4–6 часов в неделю",
    ...
    },
    {
      ...
      quoteAuthor: "Главный вывод",
      resultsSummary: "Потери и дубли заявок устранены (раньше — 10–15%) / Экономия 9–12 часов в неделю на обработке заявок / Ежедневные отчёты и аналитика в реальном времени / Система работает автономно",
      buttonText: "Читать кейс →",
