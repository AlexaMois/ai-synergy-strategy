        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          {cases.map((caseItem, index) => {
            ...
            return (
              <div
                key={index}
                className={`p-6 rounded-[20px] bg-white shadow-card transition-all duration-300 hover:shadow-hover hover:-translate-y-1 hover:scale-[1.02] hover:bg-primary-light/15 flex flex-col ${isVisible ? 'animate-fade-in-up' : 'opacity-0'}`}
                style={{
