            ...
            <div className="lg:col-span-7 space-y-4 sm:space-y-5 md:space-y-6 animate-fade-in-left">
              ...
              <div className="p-5 sm:p-6 rounded-2xl bg-white shadow-card gradient-border gradient-border-hover">
                <div className="space-y-3">
                  ...
                  <p className="text-base text-text-body leading-relaxed">Менеджеры не успевают на лиды? Первичка вбивается вручную? Склад то забит, то пуст? Маржу видите 20-го?                                                                                                               За 3–6 месяцев: ответ на лида в минуты, первичка автоматом, склад по прогнозу, маржа каждый день. Гарантирую ROI 200–400% или не беру проект.<span className="font-semibold">  
 За 3–6 месяцев: ответ на лида в минуты, первичка автоматом, склад по прогнозу, маржа каждый день. Гарантирую ROI 200–400% или не беру проект.</span>
                  </p>
                </div>
              </div>
            ...
            <div className="lg:col-span-5 flex items-center justify-center animate-fade-in-right">
              <img src={alexandraHeadshot} alt="Александра Моисеева — независимый инженер по ИИ и цифровой архитектуре" width="522" height="630" className="w-full max-w-full sm:max-w-xl lg:max-w-2xl h-auto object-contain" loading="eager" fetchPriority="high" decoding="async" />
            </div>
          </div>
        </Tabs>
      </div>
