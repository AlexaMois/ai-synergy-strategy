...
const Hero = () => {
  ...
  const tabsContent = {
    ...
    operations: {
      title: "Как внедрять технологии, не нарушая устойчивость системы",
      description: "Честная оценка зрелости процессов, рисков, архитектуры и реальных возможностей ИИ.",
      button1: "Пройти экспресс-аудит процессов",
      button2: 'Скачать чек-лист "10 вопросов перед внедрением ИИ"'
    },
    it: {
      title: "Что важно собственнику, операционному директору и ИТ-директору",
      description: "Персонализированные рекомендации под три роли: управленческое влияние, эффективность процессов и архитектурная устойчивость.",
      button1: "Пройти экспресс-аудит процессов",
      button2: 'Скачать чек-лист "10 вопросов перед внедрением ИИ"'
    }
  };
