              ...
              <TabsContent value="ceo" className="mt-0 data-[state=active]:animate-fade-in transition-all duration-300">
                <div className="space-y-4">
                  ...
                  <p className="text-lg text-text-body leading-relaxed max-w-xl">
                    Получите <span className="font-semibold">честную оценку процессов, рисков и экономического эффекта</span>: какие решения дадут эффект, во что не стоит вкладываться и в какой последовательности двигаться.
                  </p>
