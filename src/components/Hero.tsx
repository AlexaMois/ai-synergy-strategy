...
const Hero = () => {
  ...
  <span className="font-semibold">За 3–6 месяцев: ответ на лида в минуты, первичка автоматом, склад по прогнозу, маржа каждый день. Гарантирую ROI 200–400% или не беру проект.</span>
                  </p>
                </div>
              </div>
