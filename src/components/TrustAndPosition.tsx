  ...
  return (
    <section ref={ref} className="relative py-10 md:py-16 lg:py-20 overflow-hidden bg-background">
      <div className="container mx-auto">
        ...
        <div className={`max-w-7xl mx-auto bg-background rounded-3xl p-6 sm:p-8 md:p-12 lg:p-14 shadow-card ${getAnimationClass('animate-fade-in-up', 'animate-mobile-slide-up')}`}>
          <div className="grid lg:grid-cols-2 gap-6 lg:gap-10 xl:gap-12">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 auto-rows-fr">
                {/* Карточка 1 */}
                <div className={`p-4 sm:p-6 rounded-xl flex flex-col justify-center h-full min-h-[160px] bg-muted shadow-soft border border-border transition-all duration-300 hover:bg-primary/10 ${getStaggeredClass(0)}`}>
...
а где превращается в лишние затраты</p>
                ...
                <div className={`p-4 sm:p-6 rounded-xl flex flex-col justify-center h-full min-h-[160px] bg-muted shadow-soft border border-border transition-all duration-300 hover:bg-primary/10 ${getStaggeredClass(1)}`}>
                  <p className="text-lg font-semibold text-foreground leading-relaxed mb-2">
                ...
                {/* Карточка 3 */}
                <div className={`p-4 sm:p-6 rounded-xl flex flex-col justify-center h-full min-h-[160px] bg-muted shadow-soft border border-border transition-all duration-300 hover:bg-primary/10 ${getStaggeredClass(2)}`}>
                  <p className="text-lg font-semibold text-foreground leading-relaxed mb-2">
                ...
                {/* Карточка 4 */}
                <div ref={counterRef as any} className={`p-4 sm:p-6 rounded-xl flex flex-col justify-center h-full min-h-[160px] bg-muted shadow-soft border border-border transition-all duration-300 hover:bg-primary/10 ${getStaggeredClass(3)}`}>
                  <p className="text-lg font-semibold text-foreground leading-relaxed mb-2">
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className={`flex flex-col sm:flex-row items-center gap-4 p-4 sm:p-5 rounded-2xl sm:rounded-full bg-card shadow-soft border border-border transition-all duration-300 hover:bg-primary/10 ${getStaggeredClass(4)}`}>
                ...
                <div className={`flex flex-col sm:flex-row items-center gap-4 p-4 sm:p-5 rounded-2xl sm:rounded-full bg-card shadow-soft border border-border transition-all duration-300 hover:bg-primary/10 ${getStaggeredClass(5)}`}>
                  <div className="flex-shrink-0 w-12 h-12 rounded-full flex items-center justify-center bg-primary">
                ...
                <div className={`flex flex-col sm:flex-row items-center gap-4 p-4 sm:p-5 rounded-2xl sm:rounded-full bg-card shadow-soft border border-border transition-all duration-300 hover:bg-primary/10 ${getStaggeredClass(6)}`}>
                  <div className="flex-shrink-0 w-12 h-12 rounded-full flex items-center justify-center bg-primary">
                ...
                <div className={`flex flex-col sm:flex-row items-center gap-4 p-4 sm:p-5 rounded-2xl sm:rounded-full bg-card shadow-soft border border-border transition-all duration-300 hover:bg-primary/10 ${getStaggeredClass(7)}`}>
                  <div className="flex-shrink-0 w-12 h-12 rounded-full flex items-center justify-center bg-primary">
