          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-4 auto-rows-fr">
                {/* Карточка 1 */}
                <div 
                  className="p-6 rounded-xl text-center flex items-center justify-center h-full min-h-[160px] bg-[hsl(var(--gray-50))] shadow-card transition-transform duration-300 hover:scale-[1.02]"
                >
                ...
                {/* Карточка 2 */}
                <div 
                  className="p-6 rounded-xl flex flex-col justify-center h-full min-h-[160px] bg-[hsl(var(--gray-50))] shadow-card transition-transform duration-300 hover:scale-[1.02]"
                >
            ...
            <div>
              ...
              <div className="space-y-4">
                <div 
                  className="flex items-center gap-4 p-5 rounded-full bg-white shadow-card transition-transform duration-300 hover:scale-[1.02]"
                >
                  <div 
