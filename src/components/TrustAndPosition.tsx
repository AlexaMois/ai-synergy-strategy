...
const TrustAndPosition = () => {
  ...
  const trust = [
    ...
    },
    {
      ...
      text: "Дипломированный специалист по искусственному интеллекту, член ОПОРА России, резидент КРИТБИ (Красноярский региональный технологический бизнес инкубатор).",
    },
    {
      title: "Проверенная эффективность",
      text: "Ключевая метрика моей работы — сумма ненужных расходов, которых удалось избежать моим клиентам.",
    },
  ];
