...
const Card = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(({ className, ...props }, ref) => (
  <div ref={ref} className={cn("rounded-2xl border border-border/30 bg-gradient-card text-card-foreground shadow-card transition-all duration-300 hover:shadow-hover hover:scale-[1.015]", className)} {...props} />
));
