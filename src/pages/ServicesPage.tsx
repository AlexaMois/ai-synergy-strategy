          ...
          <section className="container mx-auto max-w-7xl px-4 py-16 md:py-24">
            <div className="max-w-3xl mb-10">
              ...
              <p className="text-base md:text-lg text-muted-foreground">
                Цифровое развитие начинается не с выбора сервиса. Сначала нужно понять, как работает компания: кто участвует в процессе, где повторяются действия, какие данные используются, где теряется время и что мешает руководителю видеть полную картину. В каждом проекте держу в фокусе пять опор. Итог: решение подбирается не ради технологии, а под реальную работу компании.
              </p>
            </div>
