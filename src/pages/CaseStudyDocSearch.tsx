          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="bg-primary/5 border-l-4 border-primary rounded-r-xl p-5">
              <p className="text-sm text-muted-foreground leading-relaxed">
                ...
                Везде, где есть регламенты и люди, которые их ищут. Система — не про ИИ, а про скорость доступа к информации, 
                которая уже у вас есть. Это экономит время, снижает ошибки и позволяет людям работать эффективнее.
              </p>
            </div>
