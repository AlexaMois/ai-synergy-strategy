...
const casesData: Record<string, CaseData> = {
  "aktransservice": {
    slug: "aktransservice",
    title: "АкТрансСервис",
    subtitle: "5 цифровых инструментов за 2 месяца вместо дорогого внешнего решения",
    targetAudience: "транспортная компания, работа на вахте и в нефтегазовом секторе",
    industry: "Транспорт · Вахта · Нефтегаз",
    price: "—",
    status: "действующий",
    task: "В работе было 53 000 позиций и много ручных процессов, связанных с данными, документами, контролем и внутренними задачами.",
    actions: [
  ...
  "ai-smm": {
    ...
    price: "от 250 000 ₽",
    status: "действующий",
    task: "Сократить время на создание контента, навести порядок в публикациях, автоматизировать работу SMM-команды и снизить расходы на копирайтеров и стратегов.",
    actions: [
