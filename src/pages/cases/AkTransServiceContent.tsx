      ...
      <section className="px-4 md:px-6 pb-16 md:pb-24">
        <div className="container mx-auto max-w-7xl">
          <div className="rounded-[32px] md:rounded-[40px] bg-foreground text-background px-6 md:px-12 lg:px-16 py-12 md:py-16">
            ...
            <div className="space-y-4 text-base md:text-lg text-background/70 leading-relaxed max-w-3xl mb-10">
              <p>
            ...
            <ul className="divide-y divide-background/15 border-t border-background/15">
              {automations.map((a, i) => (
                <li key={i} className="py-5 grid md:grid-cols-12 gap-2 md:gap-6 items-start">
                  ...
                  <span className="md:col-span-7 text-base text-background/70 leading-relaxed">{a.text}</span>
                </li>
              ))}
            </ul>

            <p className="text-base md:text-lg text-background/70 leading-relaxed mt-8 max-w-3xl">
