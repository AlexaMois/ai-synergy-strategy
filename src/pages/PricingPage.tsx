    ...
    <PageTransition>
      ...
      <div className="min-h-screen bg-background">
        ...
        <main>
          ...
          <FAQTeaser
            items={[
              { question: "От чего зависит итоговая цена?", answer: "Стратегическая встреча (17 000 ₽) и разработка стратегии цифрового развития (78 000 ₽) стоят фиксированную сумму. Для форматов с ценой «от» или диапазоном цена зависит от масштаба компании, количества процессов, объёма данных, уровня интеграций и глубины сопровождения." },
              { question: "Есть ли фиксированная стоимость?", answer: "Да. Стратегическая встреча — 17 000 ₽, разработка стратегии цифрового развития — 78 000 ₽. Это фиксированные цены. Аудит, обучение, внедрение, разработка и сопровождение рассчитываются по объёму задачи." },
