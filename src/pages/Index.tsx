...
const Index = () => {
  ...
  const organizationSchema = {
    ...
    "description": "Помогаю директорам производства и торговли сократить ручной труд, потери и беспорядок в процессах за 4–6 недель с помощью ИИ и автоматизации. Красноярск, работа по всей России и СНГ.",
  ...
  return (
    <div className="min-h-screen">
      <Helmet>
        ...
        <meta name="description" content="Помогаю директорам производства и торговли сократить ручной труд, потери и беспорядок в процессах за 4–6 недель с помощью ИИ и автоматизации. Красноярск, работа по всей России и СНГ." />
        ...
        <meta property="og:description" content="Помогаю директорам производства и торговли сократить ручной труд, потери и беспорядок в процессах за 4–6 недель с помощью ИИ и автоматизации. Красноярск, работа по всей России и СНГ." />
