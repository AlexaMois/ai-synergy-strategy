        ...
        <article className="max-w-none">
          ...
          <div className="text-muted-foreground leading-relaxed space-y-6">
            ...
            <section>
              ...
              <ul className="list-none space-y-2 mb-4">
                <li><strong>Яндекс Метрика (99058653)</strong> — аналитика посещаемости, карты кликов. Вебвизор отключён: запись форм и полей не ведётся. Серверы РФ. Счётчик загружается только после вашего согласия на аналитические cookies.</li>
                <li><strong>Cloudflare Web Analytics</strong> — обезличенная статистика просмотров страниц и скорости загрузки без использования cookies и профилирования.</li>
              </ul>
