        ...
        <article className="max-w-none">
          ...
          <div className="text-muted-foreground leading-relaxed space-y-6">
            <section>
              ...
              <p>
                <strong>1.2.</strong> Настоящая Политика описывает, какие cookies используются на сайте https://aleksamois.ru (далее — Сайт), для каких целей и как вы можете управлять их использованием. Аналитические cookies включаются только после вашего явного согласия, выраженного в баннере согласия.
              </p>
            </section>
            ...
            <section>
              ...
              <ul className="list-none space-y-2 mb-4">
                <li><strong>Яндекс Метрика (99058653)</strong> — аналитика посещаемости и карты кликов. Скрипт счётчика не загружается до момента получения явного согласия на аналитические cookies: при отказе или при отсутствии выбора аналитика не запускается. Вебвизор отключён — запись форм и полей не ведётся. Серверы РФ.</li>
              </ul>
              <h3 className="text-xl font-medium text-foreground mb-2">3.3. Cloudflare Web Analytics</h3>
              <p className="mb-4">
                Cloudflare Web Analytics используется на Сайте фактически и работает без cookies: сервис собирает обезличенную техническую статистику просмотров страниц и скорости загрузки, не создаёт профилей и не идентифицирует пользователя. Поэтому он не относится к cookies, требующим согласия.
              </p>
              <ul className="list-none space-y-2 mb-4">
              </ul>
              <h3 className="text-xl font-medium text-foreground mb-2">3.4. Маркетинговые cookies</h3>
              <p>
                Сайт не использует маркетинговые и рекламные cookies, а также системы управления тегами.
              </p>
            </section>
            ...
            <section>
              ...
              <ul className="list-none space-y-2">
                ...
                <li><strong>Постоянные (аналитика)</strong> — до 26 месяцев (Яндекс Метрика);</li>
            ...
            <section>
              ...
              <ul className="list-none space-y-2 mb-4">
                ...
                <li>— через ссылку «Настройки cookies» в подвале Сайта — можно изменить ранее сохранённое решение;</li>
              ...
              <p className="mt-4">
                <strong>6.3.</strong> Отключение аналитических cookies не влияет на базовую работу Сайта. Отключение строго необходимых cookies может нарушить функциональность форм и настроек.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="mb-3">
                <strong>7.2.</strong> Cloudflare Web Analytics собирает обезличенную техническую статистику без cookies и без идентификации пользователя. Google Analytics и Google Tag Manager на Сайте не используются.
              </p>
              <p>
