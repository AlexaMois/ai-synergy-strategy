        ...
        <article className="prose prose-lg max-w-none">
          ...
          <div className="bg-gray-50 p-6 rounded-lg mb-8">
            <p className="text-muted-foreground leading-relaxed">
              Заполняя любую форму на данном сайте, совершая звонок, отправляя сообщение в мессенджерах или по электронной почте, вы даете согласие ИП Моисеевой Александре Алексеевне на обработку ваших персональных данных в соответствии с Федеральным законом от 27.07.2006 № 152-ФЗ «О персональных данных».
            </p>
          </div>
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground leading-relaxed">
              Я, субъект персональных данных, действуя свободно, своей волей и в своем интересе, даю согласие ИП Моисеевой Александре Алексеевне (далее — Оператор) на обработку моих персональных данных.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground leading-relaxed">
              <strong>ИП Моисеева Александра Алексеевна</strong><br />
