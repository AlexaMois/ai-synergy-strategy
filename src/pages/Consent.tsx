        ...
        <article className="prose prose-lg max-w-none">
          ...
          <div className="text-muted-foreground leading-relaxed space-y-6">
            ...
            <section>
              ...
              <p className="mb-4">
                Согласие может быть отозвано в любое время по письменному запросу субъекта на адрес электронной почты Оператора: ai@aleksamois.ru. Отзыв согласия не влияет на законность обработки до момента отзыва.
              </p>
              <p>
