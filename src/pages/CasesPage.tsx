...
const cases: CaseItem[] = [
  ...
  { id: "kraypotrebsoyuz", client: "Крайпотребсоюз", title: "Отказ от покупки серверного оборудования — архитектура решила задачу дешевле", description: "Планировалась покупка серверного оборудования примерно за 1,5 млн ₽. Архитектура позволила отказаться от покупки. Результат — 1,3 млн ₽ разовой экономии капитальных затрат.", metrics: [{ label: "Разовая экономия капитальных затрат", value: "1,3 млн ₽" }, { label: "Экономия времени финансового отдела", value: "4–6 часов в неделю" }], industry: "services", solutionType: "automation", link: "/cases/kraypotrebsoyuz", status: "ready", image: caseKraypotrebsoyuz },
