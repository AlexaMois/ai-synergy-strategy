...
const cases: CaseItem[] = [
  { id: "aktransservice", client: "АкТрансСервис", title: "5 цифровых инструментов за 2 месяца вместо дорогого внешнего решения", description: "В работе было 53 000 позиций и много ручных процессов, связанных с данными, документами, контролем и внутренними задачами. Спроектировали и внедрили 5 цифровых инструментов за 2 месяца. Вместо дорогого внешнего решения собрали рабочую архитектуру под реальные процессы компании.", metrics: [{ label: "Сохранено", value: "1,7 млн ₽ / квартал" }, { label: "Срок", value: "2 месяца" }], industry: "logistics", solutionType: "automation", link: "/cases/aktransservice", status: "ready" },
  { id: "kraypotrebsoyuz", client: "Крайпотребсоюз", title: "Отказ от покупки серверного оборудования — архитектура решила задачу дешевле", description: "Крайпотребсоюзу нужно было автоматизировать работу с тендерами и документами. Планировалась покупка серверного оборудования примерно за 1,5 млн ₽. Я начала с разбора задачи, процессов и реальной необходимости в инструментах. В результате подобрала более рациональную архитектуру без покупки серверов и сложной разработки.", metrics: [{ label: "Разовая экономия капитальных затрат", value: "1,3 млн ₽" }, { label: "Экономия времени финансового отдела", value: "4–6 часов в неделю" }], industry: "services", solutionType: "automation", link: "/cases/kraypotrebsoyuz", status: "ready", image: caseKraypotrebsoyuz },
  { id: "doc-search", client: "Производственная компания", title: "QR-код на рабочем месте → ответ из документации за 3 секунды", description: "Для производственной компании создан интеллектуальный поиск по технической документации. Сотрудникам нужно было быстро находить ответы в материалах, где встречались текст, изображения и смешанные языки. Решение сократило время поиска и снизило зависимость сотрудников от ручного просмотра документов.", metrics: [{ label: "Экономия", value: "150–350 тыс ₽/мес" }, { label: "Время ответа", value: "3 сек" }], industry: "production", solutionType: "docs", link: "/cases/production-doc-search", status: "ready", image: caseDocSearch },
  { id: "cargo-express", client: "Грузовой Экспресс", title: "Заявки голосом и текстом → сразу в рабочую таблицу", description: "Собрана система приёма заявок из разных каналов: голос, Telegram и Excel. Заявки стали попадать в единый рабочий поток, руководитель получил понятный контроль.", metrics: [{ label: "Экономия времени", value: "9–12 ч/нед" }, { label: "Потери заявок", value: "0%" }], industry: "logistics", solutionType: "automation", link: "/cases/cargo-express", status: "ready", image: caseCargoExpress },
];
