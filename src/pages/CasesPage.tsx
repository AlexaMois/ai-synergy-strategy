...
const cases: CaseItem[] = [
  ...
  { id: "kraypotrebsoyuz", client: "Крайпотребсоюз", title: "Вместо разработки за 1,5 млн ₽ — архитектура, которая решила задачу дешевле", description: "Крайпотребсоюзу нужно было автоматизировать работу с тендерами и документами. Первоначальный путь предполагал дорогую разработку и инфраструктуру. Я начала с разбора задачи, процессов и реальной необходимости в инструментах. В результате подобрала более рациональную архитектуру без лишних затрат на серверы и сложную разработку.", metrics: [{ label: "Экономия", value: "1,3 млн ₽" }, { label: "Снижение ручной нагрузки", value: "−6 ч/нед" }], industry: "services", solutionType: "automation", link: "/cases/kraypotrebsoyuz", status: "ready", image: caseKraypotrebsoyuz },
