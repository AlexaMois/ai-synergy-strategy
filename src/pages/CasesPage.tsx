...
const cases: CaseItem[] = [
  ...
  { id: "cargo-express", client: "Грузовой Экспресс", title: "Заявки голосом и текстом → сразу в рабочую таблицу", description: "Собрана система приёма заявок из разных каналов: голос, Telegram и Excel. Заявки стали попадать в единый рабочий поток, руководитель получил понятный контроль.", metrics: [{ label: "Экономия времени", value: "3–4 ч/нед" }, { label: "Потери заявок", value: "0%" }], industry: "logistics", solutionType: "automation", link: "/cases/cargo-express", status: "ready", image: caseCargoExpress },
