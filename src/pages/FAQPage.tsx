    ...
    questions: [
      {
        ...
        answer: "В большинстве случаев — от 1 до 3 месяцев. Окупаемость считаем в конкретных показателях: часы сотрудников, снижение потерь, ускорение процессов."
      },
      {
        question: "Как посчитать ROI от внедрения ИИ?",
        answer: "ROI = (экономия + дополнительная выручка) / затраты на внедрение. Считаем на этапе диагностики: сколько теряется сейчас, сколько можно сэкономить, какой срок окупаемости."
      },
      {
      ...
      },
      {
        ...
        answer: "Анализируем причины: неверная гипотеза, проблемы с данными, сопротивление команды. Корректируем или честно говорим, что задача не решается ИИ."
      },
      {
      ...
      },
      {
        ...
        answer: "Да. Поэтому мы начинаем с диагностики и пилота. Если на этапе пилота результат не подтверждается — проект не масштабируется."
      },
      {
