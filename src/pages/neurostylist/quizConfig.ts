...
export const QUIZ_QUESTIONS: Question[] = [
  ...
  // ===== 10. Фото =====
  {
    ...
    subtitle:
      "Загрузите до 20 фото — это поможет точнее собрать образ. Шаг можно пропустить и отправить анкету без фото. Если загружаете — выберите тип для каждого.",
    required: false,
    maxPhotos: 20,
    photoTypes: PHOTO_TYPES,
    photoHint: [
      "желательно 1 фото лица при дневном свете",
      "желательно 1 фото в полный рост",
