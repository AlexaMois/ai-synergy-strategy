                ...
                <h1 className="ns-fade-up ns-delay-1 leading-[1.05]">
                  ...
                  <span
                    style={{
                      ...
                      letterSpacing: "0.01em",
                      backgroundImage:
                        "linear-gradient(135deg, #F5E6D0 0%, #D4956A 50%, #D4956A 100%)",
                  ...
                  >
                    ...
                    <span
                      style={{
                        ...
                        backgroundImage: "linear-gradient(135deg, #F5E6D0 0%, #D4956A 100%)",
                        WebkitBackgroundClip: "text",
                        backgroundClip: "text",
                        color: "transparent",
                        WebkitTextFillColor: "transparent",
              ...
              >
                ...
                <span
                  style={{
                    ...
                    backgroundImage: "linear-gradient(135deg, #F5E6D0 0%, #D4956A 50%, #D4956A 100%)",
                    WebkitBackgroundClip: "text",
                    backgroundClip: "text",
                    color: "transparent",
                    WebkitTextFillColor: "transparent",
