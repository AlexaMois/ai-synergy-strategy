...
const DESCRIPTION =
  "Автоматизация бизнес-процессов с ИИ под ключ: документооборот, продажи, контроль качества, отчётность. Разбор процессов, архитектура, пилот за 4–6 недель, обычно срок окупаемости составляет 3–6 месяцев.";
...
const faq: { q: string; a: string }[] = [
  ...
  },
  {
    ...
    a: "Разбор процессов — от 15 000 ₽, пилот одного процесса — от 200 000 ₽, полноценные системы — от 500 000 ₽. Стоимость зависит от сложности интеграций, объёма данных и требований к безопасности. Подробные сценарии — на странице цен.",
  },
  {
        ...
        <div className="container mx-auto px-4 md:px-6 max-w-5xl">
          ...
          <section className="py-8 md:py-12">
            ...
            <p className="text-lg text-foreground/80 max-w-3xl mb-6">
              Я закрываю весь цикл — от разбора бизнес-процессов до пилота, который окупается за 3–6 месяцев. Работаю с производством, торговлей, логистикой и услугами. Без замены 1С и CRM, в вашем контуре, с прозрачной экономикой.
            </p>
