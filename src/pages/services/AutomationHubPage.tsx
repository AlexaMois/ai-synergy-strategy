...
const DESCRIPTION =
  "Автоматизация бизнес-процессов с ИИ под ключ: документооборот, продажи, контроль качества, отчётность. Разбор процессов, архитектура, пилот за 4–6 недель, средняя окупаемость решений — 3 месяца.";
...
const faq: { q: string; a: string }[] = [
  ...
  },
  {
    ...
    a: "Стратегическая сессия — 17 000 ₽, стратегия цифрового развития — 78 000 ₽, глубокий аудит компании — от 116 000 ₽. Стоимость внедрения зависит от сложности интеграций, объёма данных и требований к безопасности. Подробные сценарии — на странице цен.",
  },
  {
    q: "За какое время можно запустить пилот?",
    a: "Типовой срок пилота — 4–6 недель: 1 неделя на разбор процессов и архитектуру, 2–3 недели на сборку и интеграции, 1–2 недели на тестирование и запуск с метриками до/после.",
  },
  {
        ...
        <div className="container mx-auto px-4 md:px-6 max-w-5xl">
          ...
          <section className="py-8 md:py-12">
            ...
            <p className="text-lg text-foreground/80 max-w-3xl mb-6">
              Я закрываю весь цикл — от разбора бизнес-процессов до пилота, который окупается в среднем за 3 месяца. Работаю с производством, торговлей, логистикой и услугами. Без замены 1С и CRM, в вашем контуре, с прозрачной экономикой.
            </p>
