            ...
            <div className="grid lg:grid-cols-[1fr,auto] gap-8 items-start">
              <div>
                ...
                <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-foreground mb-4">
                  Аудит процессов: карта, где утекают время и деньги
                </h1>
                <p className="text-lg text-foreground/80 max-w-2xl">
                  Бизнес тонет в задачах, сотрудники «просят ещё людей», а вы не видите, где именно утекают часы и деньги — только чувствуете перегруз. На аудите мы разбираем ключевые цепочки «от заявки до денег», фиксируем ручные провалы, считаем стоимость этой рутины и формируем карту: где автоматизация и ИИ дадут максимальную экономию и рост выручки при минимальных изменениях.
                </p>
              </div>
