...
const ArchitecturePage = () => {
  ...
  const painPoints = [
    ...
    "Разрозненные интеграции: системы не связаны между собой",
          ...
          <section className="py-8 grid md:grid-cols-3 gap-4">
            ...
            <div className="bg-card rounded-xl p-5 border border-border">
              ...
              <p className="text-sm text-foreground/70">
                Для компаний, которые уже прошли разбор процессов и понимают, что им нужно ИИ-решение. Для тех, кто хочет избежать типичных ошибок: vendor lock-in, невозможность масштабирования, разрозненные интеграции.
              </p>
            </div>
