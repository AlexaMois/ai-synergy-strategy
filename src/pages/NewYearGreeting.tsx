              ...
              <div className="bg-secondary/50 rounded-lg shadow-soft p-4 sm:p-5">
                <div className="space-y-2 text-foreground/90 text-sm sm:text-base leading-relaxed font-raleway">
                  ...
                  <div className="space-y-1.5 border-l-2 border-primary/30 pl-3 mt-3">
                    ...
                    <p>
                        Зная, на сколько Вам нравятся мои нейросотрудники,  подготовила небольшой новогодний жест — <strong className="text-foreground">AI-агенты</strong>, которых я использую и создаю сама. Вы можете забрать любой из них или сразу все три.
                    </p>
                  </div>
                </div>
              </div>
