  ...
  return (
    <PageTransition>
      ...
      <div className="min-h-screen bg-background">
                ...
                <div className="grid md:grid-cols-12 gap-6 items-center px-6 md:px-12 lg:px-16 py-12 md:py-20">
                  <div className="md:col-span-7">
                    ...
                    <p className="text-lg md:text-xl text-foreground/75 mb-6 max-w-xl leading-snug">
                      ...
                      Выберите задачу, которая ближе всего к вашей ситуации: быстрый разбор,
                      стратегия, аудит, обучение, внедрение, разработка или сопровождение.
                    </p>
                    <p className="text-lg md:text-xl text-foreground/75 mb-10 max-w-xl leading-snug">
                      Если пока не уверены, какой формат подходит, пройдите короткий разбор —
        ...
        <FAQTeaser
          items={[
            { question: "Сколько времени занимает диагностика?", answer: "Зависит от формата. Стратегическая встреча занимает меньше времени и помогает быстро определить первый шаг. Глубокий аудит требует больше погружения: интервью, анализа процессов, документов, данных и текущих инструментов." },
            { question: "Нужно ли готовить что-то заранее?", answer: "Для первой встречи достаточно кратко описать компанию, текущую задачу и процессы, которые забирают больше всего времени. Для стратегии или аудита могут понадобиться примеры документов, таблиц, схем, регламентов или описаний текущей работы." },
            { question: "Это платно?", answer: "Да. Каждый формат имеет свою стоимость и результат. Стратегическая встреча, стратегия, аудит, обучение, внедрение и сопровождение — это отдельные форматы работы." },
            { question: "Что я получу на выходе?", answer: "Вы получите понятный следующий шаг: какие процессы требуют внимания, какой формат работы подходит, что можно улучшить первым и какие действия стоит запланировать дальше." },
          ]}
        />
        <Footer />
      </div>
