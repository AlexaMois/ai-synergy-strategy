  ...
  return (
    <PageTransition>
      ...
      <div className="min-h-screen bg-background">
                ...
                <div className="px-5 md:px-10 lg:px-14 py-7 md:py-14">
                  <div className="max-w-4xl">
                    ...
                    <div className="text-sm sm:text-base text-foreground/70 mb-6 md:mb-8 max-w-2xl space-y-1">
                      <p>
                        Проводит разбор Александра Моисеева, руководитель «НейроРешений»&nbsp;
                      </p>
        ...
        <FAQTeaser
          items={[
            { question: "Что такое разбор цифровых задач для собственника?", answer: "Это онлайн/офлайн встреча, на которой мы разбираем задачу бизнеса, текущий процесс, ручную нагрузку и потери, а затем определяем первый приоритет и подходящий формат решения" },
